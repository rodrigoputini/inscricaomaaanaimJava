...
app.factory('loginService',function($http, $location, sessionService){
	return{
		login:function(data,scope){
			var $promise=$http.post('http://10.110.112.120:8080/eventoscwb-war/rest/login/auth',data); //send data to backend java
		...
		setMenus:function(scope){
			...
			var $retMenu=$http.post('http://10.110.112.120:8080/eventoscwb-war/rest/menu/loadmenu',sessionto); //send data to backend java
